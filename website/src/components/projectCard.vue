...
<template>
	<div data-aos="fade-up" data-aos-offset="300" class="projectCard">
		<img
			draggable="false"
			class="projectImage"
			:src="props.imgSrc"
